...
I’m a full-stack developer with six years of hands-on learning experience building web and application projects. I’ve developed multiple full-stack applications, along with numerous experimental projects that strengthened my core software engineering fundamentals.

I specialize in web development using Vue and Nuxt, and I also work with Node.js and databases such as Firestore, Supabase, MongoDB, and SQLite. On the frontend, I create modern, clean, and responsive interfaces using JavaScript and TypeScript, with CSS frameworks and tools including Tailwind CSS, Vuetify, Bootstrap, and SCSS.

I enjoy improving existing codebases, refining features, and learning through continuous iteration. I’m currently pursuing a Computer Engineering degree and am actively seeking software engineering internships or junior web development roles where I can contribute meaningfully, continue learning, and grow as a developer.
